...
Exp1=$(curl -sS https://raw.githubusercontent.com/BjhonStore/Bjhon/main/ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
...
echo -e "[ ${green}INFO${NC} ] Anda Telah Di Ijinkan, Untuk Menginstall Script Ini"
sleep 2
mkdir -p /var/lib/scrz-prem >/dev/null 2>&1
echo "IP=" >> /var/lib/scrz-prem/ipvps.conf
sudo apt install vnstat
sudo apt insta squid
wget -q -O https://raw.githubusercontent.com/BjhonStore/Bjhon/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
clear
...
sleep 2
clear
curl "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/BjhonStore/Bjhon/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/BjhonStore/Bjhon/main/demeling.sh && chmod +x demeling.sh && ./demeling.sh
cd
mkdir -p /root/udp
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
...
sleep 2
clear
curl "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/Insshws/insshws.sh" | bash
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/Final/notramcpu" && chmod +x /usr/bin/notramcpu
cd
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
curl "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/menu/insray.sh" | bash
sleep 1
curl "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/arca.sh" | bash
sleep 1
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install slowdns               $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O slowdns.sh https://raw.githubusercontent.com/BjhonStore/Bjhon/main/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
mkdir /root/akun
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 1
curl "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/ipsec/ipsec.sh" | bash
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
wget "https://raw.githubusercontent.com/BjhonStore/Bjhon/main/Insshws/vpn.sh" && bash vpn.sh && rm vpn.sh
clear
echo "Installing Bot Panel" | lolcat
echo "Siapkan Token bot dan ID telegram mu"
rm -rf bot.sh && wget https://raw.githubusercontent.com/BjhonStore/Bjhon/main/botssh/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn
USERID=6127773468
KEY="7409661884:AAHLXzywcgjvnBQJlkIZBhaKrEG9b8zODYg"
TIMEOUT="10"
